...
Achieve greater clarity, overcome obstacles, and propel your professional growth with the dedicated support of an experienced executive coach.`,
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 font-sans backdrop-blur-sm">
      ...
      {/* MODAL CONTAINER */}
      {/* Resized to Standard Laptop Friendly Size */}
      <div
        className="bg-white rounded-2xl shadow-2xl relative flex w-full max-w-[1080px] overflow-hidden"
      ...
      >
        ...
        <div className="flex-1 flex flex-col h-full border-r border-gray-100">
            ...
            <div className="flex-1 overflow-y-auto px-8 py-6 custom-scrollbar">
                ...
                {/* STEP INDICATOR */}
                <div className="mb-6">
                    {/* Step 2 of 2: Blue Color applied */}
                    <p className="text-[13px] text-[#2D60FF] font-semibold mb-1">Step 2 of 2</p> 
                    <h1 className="text-[26px] font-bold text-[#1A1A1A] mb-1">Choose an engagement</h1>
                ...
                {/* --- SELECTION AREA --- */}
                <div className="flex pb-6 mb-2">
                    
                    {/* LEFT COL: MENU BUTTONS (Compact Gap) */}
                    ...
                    <div className="flex-1 pt-1">
                        <h3 className="font-bold text-[18px] text-[#808080] mb-3">
                             {selectedData.title}
                        </h3>
                        <p className="text-[14px] text-gray-600 leading-[24px] whitespace-pre-line">
                             {selectedData.text}
                        </p>
                    </div>
                </div>
                ...
                {/* --- FORM SECTION --- */}
                <div>
                    {/* Line Removed here (No Border Bottom) */}
                    <div className="mb-4 border-b border-grey-400 ">
                        <h4 className="font-bold text-[18px] text-[#1A1A1A]">
                            Describe your business need
                        </h4>
                        <hr></hr>
                    </div>
                    
                    {/* Textarea (Adjusted Height for Screen fit) */}
                    <div className="mb-5">
                    ...
                    <div>
                        ...
                        <div className="border-2 border-dashed border-gray-300 rounded-[12px] h-[160px] flex flex-col items-center justify-center bg-[#FAFAFA] hover:bg-[#F5F5F5] transition relative">
            ...
            <div className="px-8 py-5 border-t border-gray-200 flex justify-between items-center shrink-0">
                ...
                <button 
                    onClick={onSubmit}
                    className="px-10 py-2.5 bg-[#2D60FF] text-white rounded-xl text-[15px] font-semibold shadow-md hover:bg-blue-700 transition"
                >
                    Submit
                </button>
            </div>
        ...
        {/* --- RIGHT SECTION (IMAGE) --- */}
        <div className="w-[35%] h-full bg-[#FAFBFF] flex items-center justify-center relative border-l border-gray-100">
            <img 
                src={ImageRight} 
                alt="Illustration" 
